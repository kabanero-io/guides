...
* **permalink**
   * The naming convention for `permalink` is `/guides/` followed by the same name of the directory you created (your guides name). The trailing slash `/` is needed, double check its added.
